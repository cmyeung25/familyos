...
const chatId = process.argv[2] || "debug-v2";
const userText = process.argv[3] || "BB 飲奶";
const telegramUserId = process.argv[4] || "7476829331";
const bridge = new CodexBridge({ workspace, timeoutMs: Number(process.env.FAMILY_OS_CODEX_TIMEOUT_MS || 300000) });
...
console.log("BRIDGE_REPLY_START");
console.log(JSON.stringify(reply, null, 2));
console.log("BRIDGE_REPLY_END");
