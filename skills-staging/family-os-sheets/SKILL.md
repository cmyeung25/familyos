...
- Read [consumable-workflows.md](references/consumable-workflows.md) for restock reminders, shopping lists, diaper-to-inventory linkage, and percentage-tracked consumables.
